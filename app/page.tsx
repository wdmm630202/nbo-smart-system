...
const projects: Project[] = [
  ...
  },
  {
    ...
    category: "网页",
    status: "内部账号运行中",
    summary: "最高管理员、经理、普通员工在同一个电脑与手机工作台管理客户、订单、拍摄流程与财务；客户历史面板按客户集中显示全部订单与累计消费；访问首页会跳转内部 /login。",
    detail: "自有域名使用私有会话承载内部账号；老板账号恢复路径由 Cloudflare Access 保护。客户历史面板保留每笔独立订单，并集中显示消费、实收、待收与拍摄历史。",
    tags: ["客户历史", "累计消费", "三层权限"],
    tone: "sky",
    visual: "erp",
    href: "https://erp.nanbostudio.com",
